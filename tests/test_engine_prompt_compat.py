...
# 确保配置加载不报错（测试环境用占位值）
os.environ.setdefault("LLM_MAIN_API_KEY", "sk-test")
os.environ.setdefault("LLM_MAIN_BASE_URL", "http://localhost")
os.environ.setdefault("LLM_MAIN_MODEL_NAME", "test-model")
